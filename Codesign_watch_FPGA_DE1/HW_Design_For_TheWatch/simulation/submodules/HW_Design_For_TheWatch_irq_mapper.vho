...
--synthesis_resources = 
 ...
 ENTITY  HW_Design_For_TheWatch_irq_mapper IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
 ...
 END HW_Design_For_TheWatch_irq_mapper;

 ARCHITECTURE RTL OF HW_Design_For_TheWatch_irq_mapper IS
 ...
 END RTL; --HW_Design_For_TheWatch_irq_mapper
