...
--synthesis_resources = 
 ...
 ENTITY  HW_Design_For_TheWatch_rsp_xbar_demux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END HW_Design_For_TheWatch_rsp_xbar_demux_002;

 ARCHITECTURE RTL OF HW_Design_For_TheWatch_rsp_xbar_demux_002 IS
 ...
 END RTL; --HW_Design_For_TheWatch_rsp_xbar_demux_002
