add wave -noupdate -divider {HW_Design_For_TheWatch_CPU: top-level ports}
...
add wave -noupdate -divider {HW_Design_For_TheWatch_CPU: common}
...
add wave -noupdate -divider {HW_Design_For_TheWatch_CPU: breaks}
