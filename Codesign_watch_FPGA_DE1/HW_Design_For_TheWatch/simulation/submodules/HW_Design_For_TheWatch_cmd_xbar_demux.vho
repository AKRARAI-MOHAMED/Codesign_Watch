...
--synthesis_resources = 
 ...
 ENTITY  HW_Design_For_TheWatch_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END HW_Design_For_TheWatch_cmd_xbar_demux;

 ARCHITECTURE RTL OF HW_Design_For_TheWatch_cmd_xbar_demux IS
 ...
 END RTL; --HW_Design_For_TheWatch_cmd_xbar_demux
