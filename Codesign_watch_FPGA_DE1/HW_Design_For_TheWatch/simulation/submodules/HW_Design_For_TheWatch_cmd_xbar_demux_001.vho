...
--synthesis_resources = 
 ...
 ENTITY  HW_Design_For_TheWatch_cmd_xbar_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END HW_Design_For_TheWatch_cmd_xbar_demux_001;

 ARCHITECTURE RTL OF HW_Design_For_TheWatch_cmd_xbar_demux_001 IS
	 ...
	 SIGNAL  s_wire_hw_design_for_thewatch_cmd_xbar_demux_001_wideor0_21_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_hw_design_for_thewatch_cmd_xbar_demux_001_wideor0_21_dataout <= (((((((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0)) OR wire_w_lg_w_sink_channel_range15w16w(0)) OR wire_w_lg_w_sink_channel_range18w19w(0)) OR wire_w_lg_w_sink_channel_range21w22w(0)) OR wire_w_lg_w_sink_channel_range24w25w(0)) OR wire_w_lg_w_sink_channel_range27w28w(0));
	sink_ready <= s_wire_hw_design_for_thewatch_cmd_xbar_demux_001_wideor0_21_dataout;
 ...
 END RTL; --HW_Design_For_TheWatch_cmd_xbar_demux_001
